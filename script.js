const gameData = [
    ...
    },
    {
      ...
      choices: [
        { text: 'Tahu bagaimana', effect: -1000, response: 'Kadang itu perlu, tapi hati-hati.' },
        { text: 'Saling mempercayai', effect: -99, response: 'Aku mengerti, itu menyakitkan.' },
        { text: 'Memberi dan menerima', effect: +4, response: 'Itu sangat penting untuk hubungan kuat.' },
      ]
    },
    {
      bg: '3.jpg',
  ...
  function loadChapter() {
    ...
    chapter.choices.forEach((choice) => {
      ...
      btn.onclick = () => {
        ...
        selectionAudio.play().catch(e => console.log("Audio play failed:", e));
  ...
  function showEnding() {
    ...
    // Play ending audio
    endingAudio.src = ending.audio;
    endingAudio.play().catch(e => console.log("Ending audio play failed:", e));
